    ...
    if($blogImgType){
        ...
        if($fileType == "image"){
            ...
            if($fileExtension == "jpg" || $fileExtension == "jpeg" || $fileExtension == "gif" || $fileExtension == "png"){
                ...
                $sql = "UPDATE myBlog SET blogTitle = '$blogTitle', blogContents = '$blogContents', blogCategory = '$blogCategory', blogImgSrc = '$blogImgName' , blogImgSize = '$blogImgSize' WHERE blogId = '$blogId'";
            } else {
        ...
        //echo "이미지 파일이 아닙니다.";
        $sql = "UPDATE myBlog SET blogTitle = '$blogTitle', blogContents = '$blogContents', blogCategory = '$blogCategory' WHERE blogId = '$blogId'";
    }
    //이미지 사이즈 확인
