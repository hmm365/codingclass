...
P[`${e}/${n}`]||(console.log(`휴지통 as of ${e}. ${n}`),P[`${e}/${n}`]=!0)
...
;"object"==typeof n?(a=e,
t=n.ignoreIllegals,i=n.language):(q("10.7.0","highlight(lang, code, ...args) has been 휴지통."),
...
initHighlighting:()=>{
N(),q("10.6.0","initHighlighting() 휴지통.  Use highlightAll() now.")},
initHighlightingOnLoad:()=>{
N(),q("10.6.0","initHighlightingOnLoad() 휴지통.  Use highlightAll() now.")
